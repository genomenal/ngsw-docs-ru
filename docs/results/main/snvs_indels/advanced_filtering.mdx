...
создайте новое условие, как описано [здесь](/results/main/snvs_indels/advanced_filtering#добавление-следующего-условия).
...
Выключение условия полезно, если вы не хотите потерять составленное условие, но в данный момент вам не
нужна фильтрация по нему.
