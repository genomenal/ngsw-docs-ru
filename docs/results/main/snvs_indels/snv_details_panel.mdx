...
- ***Идентификаторы транскрипта*** из базы [Ensembl](https://www.ensembl.org/Homo_sapiens/Info/Index) (ENSTxxxxx) и
из базы [RefSeq](https://www.ncbi.nlm.nih.gov/nuccore/) (NM_xxxxxx.x).
Нажав на идентификаторы, можно открыть страницы транскриптов. Основной транскрипт гена выделен рамкой.
