...
<table>
  ...
  <tr>
   ...
   <td>Вариант, в котором произошло изменение в области сайта сплайсинга либо в пределах 1-3 оснований экзона, либо 3-8 оснований интрона
   </td>
   <td>LOW
   </td>
  </tr>
...
<table>
  ...
  <tr>
   ...
   <td>Вариант разрушающе влияет на белок, предположительно, вызывая укорочение белка, потерю его функции или нонсенс-опосредованный распад мРНК
   </td>
  </tr>
  <tr>
   <td>MODERATE
  ...
  <tr>
   ...
   <td>Предсказание влияния варианта на белок затруднено или нет доказательства влияния варианта (обычно для вариантов, попадающих в некодирующие последовательности)
   </td>
  </tr>
</table>
