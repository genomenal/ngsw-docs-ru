...
### 1. Выявление герминальных SNVs/Indels {#1-somatic-variants-discovery}
...
После успешного выполнения
стадии ["Выявление герминальных SNVs/Indels"](/results/workflow-details/fastq-analysis/germline_snvs_indels#germline-variants-discovery)
