...
настройки из раздела ["Геномные предсказания"](/settings/settings/variant-discovery-settings#phenotype-prediction).
...
3. [Геномные предсказания](/results/workflow-details/vcf-analysis/phenotypes), если в анализ была
